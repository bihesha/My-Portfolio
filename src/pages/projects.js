    ...
    return (
      <article className='relative flex items-center justify-between w-full p-12 border border-solid shadow-2xl rounded-3xl border-dark bg-light rounded-br-2xl dark:bg-dark dark:border-light'>
        ...
        <div className='flex flex-col items-start justify-between w-1/2 pl-6'>
          ...
          <p className='my-2 font-medium text-justify text-dark dark:text-light'>{summary}</p>
          <div className='flex items-center mt-12'>
            <Link href={github} target='_blank' className='w-10'><GithubIcon/></Link>
            <Link href={link} target='_blank' className='p-2 px-6 ml-4 text-lg font-semibold border rounded-lg bg-dark text-light dark:bg-light dark:text-dark hover:dark:bg-dark hover:dark:text-light hover:dark:border-light'>Visit Project</Link>
          </div>
        </div>
      </article>
    )
